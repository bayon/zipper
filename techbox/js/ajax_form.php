	...
	<div class="row"  >
		<div class="row">
			...
			<div class="item">
				...
				<input id="testo" type="button">testo</input>
			</div>
		</div>
	</div>
</div>
...
<script>
	...
	/*
	 * url: to which ajax call is made
	 * type: get, post, etc..
	 * method: name of the method at the url that you want to call
	 * class: the classname that will identify which data to be collected.
	 * returnDiv: the HTML element to return the results to.
	 */
	function testo(url,type,method,class,returnDiv){
		alert("yeah"+string);
	}
	$('#GENERIC_FORM1 #testo').click(testo('foo'));
